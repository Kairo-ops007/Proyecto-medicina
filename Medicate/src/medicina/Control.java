...
public class Control {
	...
	/**
	 * Asigna una cita al paciente y al medico con un motivo
	 * @param p
	 * @param m
	 * @param motivo
	 */
	...
	/**
	 * Cancela la cita para un paciente y un medico
	 * @param p
	 * @param c
	 */
	...
	public void registrarPaciente(Paciente p) {
		...
		FuncionesAux.ordenamientoPacientesEdad(listaPacientes);
	...
	/**
	 * Devuelve una lista de medicos con la especialidad pedida
	...
	/**
	 * 
	 * @return Una lista con pacientes obesos
	 */
	...
	/**
	 * @return devuelve un ArrayList con los pacientes con peso por debajo de lo normal
	 */
	...
	/**
	 * Da la cita por atendida añadiendo el diagnostico a la parte de enfermedades y el medicamento a la lista de medicamentos
	 * @param Cita c
	...
	/**
	 * Calcula el medico que menos citas tiene asignadas
	 * @return
	 */
	...
	public boolean equals(Object obj) {
		...
		return this.listaPacientes.equals(otroControl.getListaPacientes()) &&
				this.listaMedicos.equals(otroControl.getListaMedicos());
	}
